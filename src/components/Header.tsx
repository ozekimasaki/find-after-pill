...
export function Header({ meta, loadedCount }: HeaderProps) {
  ...
  return (
    <header className="bg-gradient-to-r from-[#65BBE9] to-[#4AA8D9] text-white shadow-lg" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.15)' }}>
      <div className="max-w-7xl mx-auto px-4 py-2.5 sm:py-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <nav aria-label="ページ内リンク" className="shrink-0">
        ...
        {(meta || (loadedCount !== undefined && loadedCount > 0)) && (
          <div className="mt-1 sm:mt-3 flex flex-wrap gap-x-3 gap-y-1 text-xs sm:text-sm text-white/90">
            <span>
